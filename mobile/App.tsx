...
function createStyles(theme: ThemeTokens) {
  return StyleSheet.create({
    ...
    segmentCard: {
      marginTop: 4,
      borderColor: "rgba(128, 106, 73, 0.24)",
    ...
    segmentSummary: { color: theme.text, fontSize: 14.5, lineHeight: 21 },
    segmentBadge: {
      minHeight: 30,
      borderRadius: 999,
      borderWidth: 1,
      borderColor: "rgba(128, 106, 73, 0.2)",
      backgroundColor: "rgba(247, 238, 217, 0.98)",
      alignItems: "center",
      justifyContent: "center",
    ...
    segmentFootnote: { color: theme.hint, fontSize: 12.5, lineHeight: 18 },
