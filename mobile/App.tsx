...
const APP_THEME_TOKENS: Record<AppColorScheme, ThemeTokens> = {
  soft_light: {
    bgTop: "#f5f1e8",
    bgBottom: "#e6dfd2",
    panel: "rgba(255, 255, 250, 0.965)",
    border: "rgba(73, 89, 74, 0.2)",
    text: "#1f2921",
    textMuted: "#556355",
    accent: "#596f5c",
    danger: "#b42318",
    success: "#40684b",
    hint: "#617060",
    ghostButtonBg: "rgba(247, 247, 241, 0.98)",
    ...
    selectedCardBg: "rgba(229, 236, 227, 0.98)",
    currentPlanCardBg: "rgba(220, 230, 219, 0.99)",
  ...
  classic_blue: {
    bgTop: "#111814",
    bgBottom: "#26332a",
    panel: "rgba(21, 30, 24, 0.88)",
    border: "rgba(154, 174, 156, 0.3)",
    text: "#eef4ec",
    textMuted: "#bcc7bc",
    accent: "#8caf93",
    danger: "#ff7c7c",
    success: "#8fcca0",
    hint: "#b0bcae",
    ghostButtonBg: "rgba(28, 41, 32, 0.62)",
    ...
    selectedCardBg: "rgba(39, 56, 42, 0.94)",
    currentPlanCardBg: "rgba(36, 53, 39, 0.95)",
...
function createStyles(theme: ThemeTokens) {
  return StyleSheet.create({
    ...
    heroMarkFrame: {
      ...
      borderRadius: 28,
      borderWidth: 1,
      borderColor: "rgba(244, 231, 206, 0.22)",
    ...
    segmentLabel: { color: APP_SURFACE_COLORS.goldMuted, fontSize: 12, fontWeight: "800", textTransform: "uppercase", letterSpacing: 0.9 },
    segmentTitle: { color: theme.text, fontSize: 24, fontWeight: "800", lineHeight: 28 },
    segmentSummary: { color: theme.text, fontSize: 14.5, lineHeight: 21, fontWeight: "600" },
    segmentBadge: {
      minHeight: 30,
      borderRadius: 999,
      borderWidth: 1,
    ...
    segmentBadgeText: { color: theme.primaryButtonText, fontSize: 11.5, fontWeight: "800", textTransform: "uppercase", letterSpacing: 0.8 },
    ...
    menuOverlayBackdrop: { ...StyleSheet.absoluteFill, backgroundColor: theme.menuOverlayBackdrop },
    ...
    dropdownModalBackdrop: { ...StyleSheet.absoluteFill, backgroundColor: theme.dropdownModalBackdrop },
    ...
    homePrimaryButton: {
      ...
      borderWidth: 1,
      borderColor: "rgba(240, 223, 192, 0.2)",
      marginBottom: 16,
      shadowColor: APP_SURFACE_COLORS.shadow,
      shadowOpacity: 0.12,
      shadowRadius: 12,
