const FAST_START_MIN_TOTAL_CHARS = 110;
const FAST_START_FIRST_CHUNK_MIN_CHARS = 55;
const FAST_START_FIRST_CHUNK_TARGET_CHARS = 120;
const FAST_START_LATER_CHUNK_MIN_CHARS = 80;
const FAST_START_LATER_CHUNK_TARGET_CHARS = 220;
const FAST_START_MIN_REMAINDER_CHARS = 28;
const FAST_START_MAX_CHUNKS = 3;
const FAST_START_LONG_SENTENCE_SPLIT_MIN_CHARS = 150;
